...
👉 **SplitText Animations**: An impactful text reveals using GSAP’s SplitText for dynamic intros and section highlights.
...
👉 **Custom Carousel**: Built a fully customized carousel with multiple navigation options and animated slides.
...
```bash
git clone https://github.com/ManicAlex/cocktail_gsap_landing.git
cd cocktail_gsap_landings
```
